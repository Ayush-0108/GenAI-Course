...
class Review(BaseModel):
    key_themes : list[str]= Field(description = "Tell all the key themes in the review in a list")
    summary : str= Field(description = "give a brief summary of the review")
    pros : Optional[list[str]] = Field(default = None,description= "tell all the pros from the review")
    cons : Optional[list[str]] = Field(default = None,description= "tell all the cons from the review")
    sentiment :Literal["pos","neg","neutral"] = Field(description="give the sentiment of the review as positive negative or neutral")
